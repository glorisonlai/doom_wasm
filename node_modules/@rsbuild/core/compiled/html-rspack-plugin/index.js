(() => {
  var __webpack_modules__ = {
    178: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const { HtmlWebpackChildCompiler } = __nccwpck_require__(355);
    ...
    839: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      const promisify = __nccwpck_require__(23).promisify;
      const vm = __nccwpck_require__(154);
      const fs = __nccwpck_require__(896);
      const path = __nccwpck_require__(928);
      const { CachedChildCompilation } = __nccwpck_require__(178);
      const { createHtmlTagObject, htmlTagObjectToString, HtmlTagArray } =
        __nccwpck_require__(422);
      const prettyError = __nccwpck_require__(256);
      const chunkSorter = __nccwpck_require__(361);
      const getHtmlRspackPluginHooks =
        __nccwpck_require__(759).getHtmlRspackPluginHooks;
  ...
  var __webpack_exports__ = __nccwpck_require__(839);
